# Generated by Django 5.1.1 on 2024-09-20 00:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo_negocio', models.ImageField(null=True, upload_to='imagenes/', verbose_name='logo')),
                ...
                ('usuario_administrador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='negocios', to=settings.AUTH_USER_MODEL, verbose_name='Usuario Administrador')),
            ],
        ),
        migrations.CreateModel(
            name='producto',
            fields=[
                ...
                ('Id_negocio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.negocio', verbose_name='Id_negocio')),
            ],
        ),
        migrations.CreateModel(
            name='Reserva',
